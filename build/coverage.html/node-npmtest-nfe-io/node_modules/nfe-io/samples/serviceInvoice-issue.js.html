...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-nfe-io/node_modules/nfe-io/samples/serviceInvoice-issue.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header high">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-nfe-io/node_modules/nfe-io/samples/serviceInvoice-issue.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-nfe-io/node_modules/nfe-io/samples/</a> &#187; serviceInvoice-issue.js</div>
</div>
<div class="body">
...
&nbsp;
  function(err, invoice) {
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (invoice) <span class="cstat-no" title="statement not covered" >console.log('invoice', invoice.code, invoice.location);</span>
